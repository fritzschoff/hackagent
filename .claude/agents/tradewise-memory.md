...
- 2026-05-18: **Base mainnet IPO LIVE.** AgentShares `0x6aF06f682A7Ba7Db32587FDedF51B9190EF738fA`, RevenueSplitter `0x477D6FeFCE87B627a7B2215ee62a4E21fc102BbA`, SharesSale `0x12D4c1F3f8b4E372c4575E9EE336da7497A67Ba1`. Founder `0x52d5863a4f0901EEE3D3773123B70178380bf2d8` holds 2000 TRADE; SharesSale holds 8000 TRADE @ 0.10 USDC each. USDC: `0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913` (Circle native). Broadcaster ended at 0 TRADE (atomic split). Edge Config `addresses_base_mainnet` populated. AgentShares share-address coincidence with HyperliquidTreasury on chain 999 is just same-nonce: both deployed first from agent EOA on their respective chains.
- 2026-05-18: **D2 + D3 CCTP cross-chain dividend LIVE.** DividendStep2Burn KH workflow `s0uvjl6xruosa8tffnyt8` (Sundays 00:15 UTC, 15min after D1), DividendStep3Mint `1x8i2x0p1f2k2tjz6mz6s` (every 5min). KEEPERHUB_WORKFLOW_ID_DIVIDEND_STEP_2 + _3 in Vercel env. End-to-end flow now functions: D1 HL→Arbitrum (withdraw3) → D2 burn on Arbitrum (CCTP TokenMessenger `0x19330d10D9Cc8751218eaf51E8885D058642E08A`, domain 6 = Base) → ~13min iris attestation wait → D3 receiveMessage on Base (MessageTransmitter `0xAD09780d193884d503182aD4588450C416D6F9D4`) mints directly into the splitter. TRADE holders pull via splitter.claim() — MasterChef accumulator means no explicit distribute() needed.
